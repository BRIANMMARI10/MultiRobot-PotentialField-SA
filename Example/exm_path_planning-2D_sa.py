import sys
sys.path.append('./src')
sys.stdout = open("simulation_output_sa.txt", "w")
...
# Results CSV setup
csv_filename = 'simulation_results_sa.csv'
...
for N in N_values:
    for trial in range(num_trials):
        ...
        # Apply optimized repulsion weight from calibration to actual field
        potential_field.repulsion_weight = temp_field.repulsion_weight
